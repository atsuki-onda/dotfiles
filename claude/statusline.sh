...
__emit '1;97;48;2;54;54;54' ' '
__v="$(__field 'model.display_name')"
__emit '1;97;48;2;54;54;54' "$__v"
__emit '1;97;48;2;54;54;54' ' /'
__emit '1;97;48;2;54;54;54' ' '
...
if [ "$(__field 'fast_mode')" = 'true' ]; then
  __emit '1;38;2;237;17;17;48;2;240;235;235' '⚡fast'
fi
__emit '1;97;48;2;54;54;54' ' '
__v="$(__field 'cost.total_duration_ms')"
__out="$(__dur_human "${__v:-0}")"
__emit '1;97;48;2;54;54;54' "$__out"
__emit '1;97;48;2;54;54;54' ' '
__reset
printf '\n'
__reset
...
if [ "$(__git_dirty)" = '1' ]; then
  __emit '38;2;180;255;57;49' '◆'
else
  __emit '38;2;251;146;60;49' '◇'
fi
__emit '39;49' ' '
__reset
printf '\n'
...
__emit '' "$__uf/$__tf ($__p%)"
__emit '' ' '
__emit '39' '['
__v="$(__field 'context_window.used_percentage')"
__bar_out="$(__bar "$__v" 20 '▓' '░')"
__emit '39' "$__bar_out"
__emit '39' ' ]'
__reset
printf '\n'
